...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheMovieDatabase.Posters();
  });
  ...
  describe('Posters', function() {
    it('should create an instance of Posters', function() {
      // uncomment below and update the code to test Posters
      //var instane = new TheMovieDatabase.Posters();
      //expect(instance).to.be.a(TheMovieDatabase.Posters);
    });
    ...
    it('should have the property detailed (base name: "detailed")', function() {
      // uncomment below and update the code to test the property detailed
      //var instane = new TheMovieDatabase.Posters();
      //expect(instance).to.be();
    });
